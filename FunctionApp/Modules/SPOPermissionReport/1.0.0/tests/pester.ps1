...
Remove-Module SPOPermissionReport -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\SPOPermissionReport.psd1"
Import-Module "$PSScriptRoot\..\SPOPermissionReport.psm1" -Force
